...
public class Property_Modify_Panel extends JPanel{
  ...
  Property_Modify_Panel ref=this;
  ...
  final JTextField latest=new JTextField(5);
    ...
    public Property_Modify_Panel(mdpanel md){
        this.md=md;
    ...
    public static void main(String [] args){
        new Property_Modify_Panel(new mdpanel());//.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
