...
public class LoanView extends JFrame 
{
    ...
    {           
                ...
                jtb.addTab("View Loan",new ViewLoan());
                jp3.add(jtb);
    ...
    public class ViewLoan extends JPanel
    {
        public ViewLoan()
        {
            ...
            jp5.add(new JRadioButton("Home"));
            jp5.add(new JRadioButton("Personal"));
            jp5.add(new JRadioButton("Auto"));
            jp5.add(new JRadioButton("Education"));
    ...
    {
        new LoanView().setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    }
}
