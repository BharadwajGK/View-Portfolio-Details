 ...
 */
public class MutipleDatasetDemo extends ApplicationFrame implements ActionListener {
     ...
     */
    public MutipleDatasetDemo(final String title) {
...
//        this.plot.setAxisOffset(new Spacer(Spacer.ABSOLUTE, 4, 4, 4, 4));
    ...
    public static void main(final String[] args) {
        ...
        final MutipleDatasetDemo demo = new MutipleDatasetDemo("Multiple Dataset Demo 1");
        demo.pack();
