...
public class PropertyView extends JFrame 
{
    ...
    {           
                ...
                jtb.addTab("View Property",new ViewProperty());
                jp3.add(jtb);
    ...
    public class ViewProperty extends JPanel
    {
        public ViewProperty()
        {
            ...
            jp5.add(new JRadioButton("Residential"));
            jp5.add(new JRadioButton("Commercial"));
            ...
            jp6.add(new JButton("View Property Details"));
            jp4.add(jp6);
    ...
    {
        new PropertyView().setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    }
}
